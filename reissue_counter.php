...
<body>
    ...
    <div class="container">
        <form action="process_reissue_counter.php" method="post">
            ...
            <div id="bankDetails" class="hidden">
                <!-- Your existing bank details fields -->
            </div>
    ...
    $(document).ready(function() {
        ...
        function calculateProfit() {
            let billAmount = parseFloat($('#billAmount').val()) || 0;
            let netPayment = parseFloat($('#NetPayment').val()) || 0;
            let profit = billAmount - netPayment;
            $('#Profit').val(profit.toFixed(2));
            
            // Also calculate due amount
        ...
        $('#paidAmount').on('input', calculateProfit);
    });
    </script>
</body>
</html>
