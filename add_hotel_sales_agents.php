    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <li>
            <a class="dropdown-item" href="add_hotel_sales_agents.php">Agents</a>
          </li>
          <li>
...
<!-- insert part is here -->
<div class="container">
    <h2>Hotel Sales Entry Form for Agents</h2>
    <form action="agent_hotel_insert_sales.php" method="POST">
