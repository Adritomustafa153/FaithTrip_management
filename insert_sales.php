...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $stmt = $conn->prepare("INSERT INTO sales 
        ...
        PaidAmount, DueAmount, PaymentMethod, BankName, BranchName, AccountNumber, ReceivedDate, DepositDate, ClearingDate, SalesPersonName,Class)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
