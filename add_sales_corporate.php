...
<div class="container">
    ...
    <form action="hotel_manual_insert_corporate_sell.php" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                    <label for="AccountNumber">Hotel Name</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <label for="TicketRoute">Country:</label>
                <input type="text" name="country" required>
            </div>
            <div class="form-group">
                <label for="TicketNumber">Hotel Address:</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="date" name="Check-In_Date" required>
            </div>
            <div class="form-group">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="roomCategory" id="roomCategory" required>
            </div>
        </div>
